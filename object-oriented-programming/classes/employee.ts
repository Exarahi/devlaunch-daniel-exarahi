...
Horizon Innovations, una destcada empresa enfocada en el bienestar de los empleados,
...
modificaciones slariales.

Para gestionar y manipular los datos salariales de manera eficiente, es util encapsulatlos
...
Esta clase incluira dos metodos claves: un "getter" para recuperar el salario actual y un "setter"
...
Adicionalmente, se incluira un metodo giveRaise para aumentar el salario en cantidad especifica
...
const e1 = new Employee('Daniel', 'Exarahi', 18000)
